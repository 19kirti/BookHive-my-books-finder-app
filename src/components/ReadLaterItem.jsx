...
const ReadLaterItem = (props) => {
    let {title, publisher, bookurl, image, handleAddToFavorites, removeFromReadLater, bookId} = props;
    ...
    return (
      ...
      <div className="card-body">
        ...
        <button onClick={removeFromReadLater} className="btn btn-danger">Remove</button>
