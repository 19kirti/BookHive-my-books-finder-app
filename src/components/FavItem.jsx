...
const FavItem = (props) => {
    let {title, publisher, bookurl, image, addToReadLater, handleRemoveFromFavorites, bookId} = props;
    ...
    return (
      ...
      <div className="card-body">
        ...
        <a href={bookurl} type="_blank" className="btn btn-info mx-3">View Book</a>
        <button onClick={handleRemoveFromFavorites} className="btn btn-danger">Remove</button>
